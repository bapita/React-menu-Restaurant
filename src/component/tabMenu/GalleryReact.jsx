...
const GalleryReact = () => {
    ...
    const filterItem = (ctgItem) => {
        const updatedItems = Menu.filter((curElem) => {
            return curElem.category === ctgItem;
        })
    ...
    return(
        ...
        {/* Main Item section starts here */}

        <div className="mt4 container-fluid menu-items">
            <div className="row">
                    ...
                    <div className="row my-5">

                        {
                            items.map((elem) => {
                                    ...
                                    return(
                                        <>
                                            <div className="item1 col-12 col-md-6 col-lg-6 col-xl-4 my-5 mx-5">
